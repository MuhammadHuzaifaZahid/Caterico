...
public class AssignedInventory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assigned_inventory);
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Order = new Intent(AssignedInventory.this,OrderDetails.class);
                ...
                builder.setMessage(R.string.alert_content) .setTitle(R.string.alert_title)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                finish();
                                Intent intent = new Intent(AssignedInventory.this,MainActivity.class);
